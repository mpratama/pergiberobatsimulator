class Level07 extends Phaser.Scene {
    ...
    create() {
        ...
        this.snake = this.physics.add.sprite(615, 150, 'ular', 0).setSize(7,12);
        ...
        this.physics.add.overlap(this.snake, this.orang, () => {console.log("kunyuk")}, null, this);
        ...
        this.snake.play('ular');
        this.snake.setBounce(0.9,0.9);
        this.snake.setCollideWorldBounds(true);
        //this.physics.add.collider(this.snake, this.orang);

        //this.box2 = this.add.rectangle(608, 144, 100, 100).setStrokeStyle(1,0x000000,1).setOrigin(0);
        this.box = new Phaser.Geom.Rectangle(608, 144, 100, 100);
        this.snake.body.setBoundsRectangle(this.box);
